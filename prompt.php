...
Task1/
|____ajax/delete_image.php, get_images.php
├── class/
│   ├── GroundBooking.php
│   └── UserImage.php , UserSuggestion.php
├── config/
│   └── database.php
├── register.php
└── edit.php
|___authentication-> login.php, logout.php
|__dashboard.php, index.php,form.php,edit.php,delete.php,register.php,update_status.php
